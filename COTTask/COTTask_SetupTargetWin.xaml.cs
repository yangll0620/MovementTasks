...
{
    /// <summary>
    /// Interaction logic for COTTask_SetupTargetWin.xaml
    /// </summary>
    public partial class COTTask_SetupTargetWin : Window
    {
        ...
        public COTTask_SetupTargetWin(MainWindow parentWindow)
        {
            InitializeComponent();
