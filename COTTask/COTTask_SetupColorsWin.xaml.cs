...
{
    /// <summary>
    /// Interaction logic for COTTask_SetupColorsWin.xaml
    /// </summary>
    public partial class COTTask_SetupColorsWin : Window
    {
        
        MainWindow parent;
        private bool BtnStartState, BtnStopState;

        public COTTask_SetupColorsWin(MainWindow parentWindow)
        {
            InitializeComponent();
