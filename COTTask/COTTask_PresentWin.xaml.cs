...
{
    /// <summary>
    /// Interaction logic for COTTask_PresentWin.xaml
    /// </summary>
    public partial class COTTask_PresentWin : Window
    {
        ...
        /*****Methods*******/
        public COTTask_PresentWin(MainWindow parentWin)
        {
            InitializeComponent();
            ...
            while (PresentTrial)
            {
                ...
                while (opi < parent.optPostions_OCenter_List.Count)
                {
                    ...
                    using (StreamWriter file = File.AppendText(file_saved))
                    {
                        ...
                        // Trial Num
                        file.WriteLine(String.Format("{0, -40}: {1}", "TrialNum (ms)", totalTriali.ToString()));
                        ...
                        // Ready Time
                        file.WriteLine(String.Format("{0, -40}: {1}", "Ready Interface Time (ms)", t_ReadyMS.ToString()));
        ...
        private void Feedback_GoERROR()
        {
            ...
            Show_OneCrossing(new int[] { (int)circleGo_centerPoint_Pixal.X, (int)circleGo_centerPoint_Pixal.Y });
